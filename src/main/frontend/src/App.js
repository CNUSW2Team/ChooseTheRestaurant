...
import RoundChoice from "./components/RoundChoice";
        ...
        <div className='App'>
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route path="/RoundChoice/:worldcupId" element={<RoundChoice />}></Route>
                    <Route path="/RoundChoice/:worldcupId/WorldCup" element={<WorldCup />}></Route>
